	...
	Calendar.prototype = {
		...
		_initializeOptions: function(opt) {
			...
			this.options = {
				...
				displayWeekNumber: opt.displayWeekNumber != null ? opt.displayWeekNumber : true,
				...
				while(currentDate <= lastDate)
				{
					...
					do
					{
						...
						if(currentDate < firstDate) {
							...
							{
								cellContent.css("color", 'ORANGE');
								//cellContent.css("fontSize", "20px");
								cellContent.css("font-weight",'900');
							}
