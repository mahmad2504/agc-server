...
<div style="font-size:10px;width:70%;text-align:center;color:grey" class="center">
	...
	<a id="foot" style="font-size:10px;color:grey" href="https://www.agileganttchart.com" target="_blank">© www.agileganttchart.com</a>
</div>
...
<script>
	...
	var transImage ="<?php echo MY_FOLDER;?>/img/trans.gif";
