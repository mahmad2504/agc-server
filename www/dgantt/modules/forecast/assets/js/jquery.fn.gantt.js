...
(function ($) {
    ...
    $.fn.gantt = function (options) {
		...
		//console.log(oa_check);
				...
				.append($('<input type="checkbox" id="oa"  '+oa_check+'>&nbspOpen Air&nbsp</input>')
                                    .click(function () {
...
$.getJSON("timechart?board="+settings.board+"&resource=data_timechart.php&vacations="+vacations+"&scale="+settings.scale+"&oa="+oa, function (jsData) {
                        element.data = jsData;
                        core.init(element);
                    });
			},
		...
		settings.oa = oa;
		settings.vacations = vacations;
$.getJSON("timechart?baseline="+settings.baseline+"&board="+settings.board+"&resource=data_timechart.php&vacations="+vacations+"&scale="+settings.scale+"&oa="+oa, function (jsData) {
                        element.data = jsData;
                        core.init(element);
                    });
