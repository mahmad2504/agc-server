...
{
	echo '<span id="title"> Earned Value Graph </span>';
	echo '<span id="end" style="float:right;"> </span>';
}
...
{
	echo '<div id="chart_div" style="height: 200px; margin: 0 auto">';
	echo '<div style="font-size:10px;color:grey" class="text-center">';
	echo '<img id="image"  width="80" height="80" style="opacity: 1.0;" alt=""></img><br>';
	echo '</div>';
	echo '</div>';
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
<body>
	<br>
		<?php 
			GeneratePanelHtml(EARNED_VALUE_GRAPH,'col-sm-12');
		?>
...
function HandleTaskData(data)
{
	...
	data = GetData(data);
	{
		...
		if(taskdata.Title.length> 50)
			$("#title").text(taskdata.Title.substring(0,50)+"... ("+taskdata.Progress+"%)");
		else
			$("#title").text(taskdata.Title+"   ("+taskdata.Progress+"%)");
		...
		$("#end").text("Finishing On-"+ConvertDateFormat(taskdata.End));
		$("#end").css("color", col);
